...
class movingDiagonally {
	private static int movingDiagonally(final int n, final int m, final int sr, final int sc, final int er, final int ec){
		final String[][] grid = new String[n][m];
		...
		final Map<int[], String> direction_mapping = new HashMap<>();
		
		final int[] d_diag = new int[]{1,1};
		final int[] l = new int[]{-1,1};
		final int[] d = new int[]{1,-1};
		final int[] u_diag = new int[]{-1,-1};
		...
		while(true){
			...
			final int new_x = home_x + dx;
			final int new_y = home_y + dy;
			...
			final int[] newDir = new int[]{dx, dy};
